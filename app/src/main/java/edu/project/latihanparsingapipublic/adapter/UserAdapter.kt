package edu.project.latihanparsingapipublic.adapter
...
import edu.project.latihanparsingapipublic.R
...
class UserAdapter(private val users: MutableList<DataItem>)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        val view:
            View = LayoutInflater.from(parent.context).inflate(R.layout.item_list_user, parent, false)
